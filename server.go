...
func main(){
	...
	// dsn := os.Getenv("postgresql://neondb_owner:npg_TqOR53vzpJhY@ep-royal-union-ancanbtj-pooler.c-6.us-east-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require")
	// if dsn == "" {
